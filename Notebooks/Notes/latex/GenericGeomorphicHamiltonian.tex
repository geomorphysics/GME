...
unless the erosion model erosion rate is independent of drainage
pattern, which is the case for ``granular flow hillslopes''. It is
essentially a static model, which is why we can convert it into a static
Hamiltonian, and can rewrite it as an eikonal equation (a static
