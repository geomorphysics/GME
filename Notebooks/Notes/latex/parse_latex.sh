...
# f="MatsumotoMetric"; t="Matsumoto's \\\textit\{Slope of a mountain\} metric"; jupyter-nbconvert --to latex "../"$f.ipynb; mv ../*.tex .; rm -rf $f"_files"; mv  ../$f"_files" .; ./parse_latex.sh $f".tex" "$t"; pdflatex $f".tex"

# f="GenericGeomorphicHamiltonian"; t="Generic geomorphic Hamiltonian"; jupyter-nbconvert --to latex "../"$f".ipynb"; mv "../"$f".tex" .; ./parse_latex.sh $f".tex" "$t"; pdflatex $f".tex"

# f="GeomorphicEikonalEquation"; t="Geomorphic Hamiltonian as an eikonal equation"; jupyter-nbconvert --to latex "../"$f.ipynb; mv ../*.tex .; ./parse_latex.sh $f".tex" "$t"; pdflatex $f".tex"
