...
class IndicatrixNew(Graphing):
    ...
    def Fstar_F_rectlinear(
        ...
        _ = self.create_figure(name, fig_size)
        axes = plt.gca()
        ...
        pz_ = - \
            float(solve(self.H_parametric_eqn.subs(
    ...
    def Fstar_F_polar(
        ...
        plt.polar(
            alpha_fn(np.arcsin(self.v_supc_array[:, 0]/norm(self.v_supc_array,
                                                            axis=1))),
        ...
        plt.polar([np.pi/2+(np.arctan(gmeq.tanalpha_ext))]*2,
                  ...
                  lw=1, label=r'$\alpha_{\mathrm{c}}$')
        plt.polar(
            alpha_fn(np.arcsin(self.v_infc_array[:, 0]/norm(self.v_infc_array,
                                                            axis=1))),
        ...
        if eta_ > 1:
            ...
            legend_xy = [1.0, 0.0]
            plt.text(*[(np.pi/2)*1.07, 0.4], 'convex',
                     horizontalalignment='center', verticalalignment='center',
                     rotation=8, fontsize=15, color='DarkRed')
            plt.text(*[(np.pi/2)*1.17, 0.28], 'concave',
                     horizontalalignment='center', verticalalignment='center',
                     rotation=13, fontsize=11, color='r')
            plt.text(*[(np.pi/3)*0.925, 0.5], 'concave',
                     horizontalalignment='center', verticalalignment='center',
                     rotation=-35, fontsize=15, color='b')
            plt.text(*[(np.pi/6)*0.7, 0.85], 'convex',
                     horizontalalignment='center', verticalalignment='center',
            ...
            legend_xy = [0.9, 0.0]
            plt.text(*[(np.pi/2)*0.94, 0.4], 'concave',
                     horizontalalignment='center', verticalalignment='center',
                     rotation=11, fontsize=15, color='r')
            plt.text(*[(np.pi/2)*0.9, -0.07], 'convex',
                     horizontalalignment='center', verticalalignment='center',
                     rotation=72, fontsize=13, color='DarkRed')
            plt.text(*[(np.pi/4)*1.2, 0.12], 'convex',
                     horizontalalignment='center', verticalalignment='center',
        ...
        axes.tick_params(axis='x', pad=0, left=True,
