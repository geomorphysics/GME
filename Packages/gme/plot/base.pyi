...
class Graphing(GraphingBase):
    ...
    def draw_rays_with_arrows_simple(self, axes: Axes, sub: Dict, xi_vh_ratio: float, t_array: np.ndarray, rx_array: np.ndarray, rz_array: np.ndarray, v_array: Optional[np.ndarray] = ..., n_t: int = ..., n_rays: int = ..., ls: str = ..., sf: float = ..., color: Optional[str] = ..., do_labels: bool = ..., do_one_ray: bool = ...) -> None: ...
