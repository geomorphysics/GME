...
class IndicatrixOld(Graphing):
    ...
    def comparison_logpolar(self, gmeq, name, fig_size=None, dpi=None,
        ...
        xtick_labels = [(r'$\frac{\pi}{' + f'{int(x_)}' + '}$' if x_ > 0
    ...
    def relative_geometry( self, gmeq, name, fig_size=None, dpi=None,
                           ...
                           x_max=3.4, n_points=100, pz_min_=1e-1 ) -> None:
        r"""
        ...
        points_tangents_dicts = {
            ...
            0.15 : {'n_vertices' : 3, 'ls' : ':',  'pz_min' : pz_min_, 'pz_max' : 1000},
            0.5  : {'n_vertices' : 4, 'ls' : '--', 'pz_min' : pz_min_, 'pz_max' : 100},
