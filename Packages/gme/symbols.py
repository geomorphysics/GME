...
Fstar = symbols('F^*',  real=True, positive=True)
Fstar_px_pz = symbols('F^{*}(p_x\,p_z)',  real=True, positive=True)
...
beta, beta_ = symbols(r'\beta \beta_x',  real=True)
