...
class EquationsBase:
    ...
    varphi_type: Any
    do_raw: Any
    def __init__(self, parameters: Optional[Dict] = ..., eta_: Rational = ..., mu_: Rational = ..., beta_type: str = ..., varphi_type: str = ..., do_raw: bool = ..., do_new_varphi_model: bool = ...) -> None: ...
...
class Equations(EquationsMixedIn):
    def __init__(self, parameters: Optional[Dict] = ..., do_new_varphi_model: bool = ..., **kwargs) -> None: ...
