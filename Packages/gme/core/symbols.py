...
pzhat_0 = symbols(r'\hat{p}_{z_0}',  real=True, negative=True)
...
alpha_ext = symbols(r'\alpha_\mathrm{ext}',  real=True)
...
xivhat_0 = symbols(r'\hat{\xi}^{\downarrow_0}',  real=True)
xiv_0 = symbols(r'\xi^{\downarrow_{0}}',  real=True,
                positive=True)   # NEW: positive=True
xih = symbols(r'\xi^{\rightarrow}',  real=True)
xihhat = symbols(r'\hat{\xi}^{\rightarrow}',  real=True)
xih_0 = symbols(r'\xi^{\rightarrow_{0}}',  real=True,
                positive=True)  # NEW: positive=True
...
gstarhat = MatrixSymbol(r'\hat{g}_*', 2, 2)
