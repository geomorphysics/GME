...
# SymPy
import sympy as sy
from sympy import Eq, sqrt, simplify, factor, solve, tan, numer, \
                  Abs, Piecewise, N, pi, atan, lambdify
...
from gme.core.symbols import \
    pz, alpha, beta, rdotx, rdotz, ta, alpha_ext, \
    eta, beta_crit, psi
...
class AnglesMixin:
    ...
    def define_tanalpha_eqns(self) -> None:
        ...
        """
        logging.info('core.angles.define_tanalpha_eqns')
    ...
    def define_tanbeta_eqns(self) -> None:
        ...
        """
        logging.info('core.angles.define_tanbeta_eqns')
    ...
    def define_psi_eqns(self) -> None:
        ...
        Attributes:
            ...
            psi_alpha_beta_eqn (:class:`~sympy.core.relational.Equality`):
                ...
                = \dfrac{\xi^{\downarrow} + v^{z}}{v^{x}}`
        """
        logging.info('core.angles.define_psi_eqns')
